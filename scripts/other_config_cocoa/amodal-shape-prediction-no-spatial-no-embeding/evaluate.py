...
def parse_args():
    ...
    parser.add_argument("--ann-file", type=str, default="../data/annotations/COCO_amodal_val2014.json", help="File annotation")
    parser.add_argument("--checkpoint", type=str, default="../checkpoints/swin_amodal_epoch_30.pth", help="Đường dẫn checkpoint")
    ...
    parser.add_argument("--output", type=str, default="results/per_image_eval.json", help="File lưu kết quả")
